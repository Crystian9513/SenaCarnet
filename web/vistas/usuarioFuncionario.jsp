...
<%
    ...
    Usuarios usuario = (Usuarios) sesion.getAttribute("funcionario");
                                    ...
                                    <div class="col-12 d-flex flex-column align-items-center pt-3">
                                        <div class="card" data-aos="flip-left"
                                            ...
                                            <div class="text-center">
                                                <button type="button" class="btn" onclick="verReporte()" data-cedula="${not empty funcionario ? funcionario.cedula : ''}" style="background-color: #6acd56;">
                                                    <b>Descargar</b>
                                                </button>
                                            </div>
                                        </div>
