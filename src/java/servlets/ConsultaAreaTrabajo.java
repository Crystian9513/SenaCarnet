 ...
 * @author Peralta
 */
@WebServlet(name = "ConsultaAreaTrabajo", urlPatterns = {"/ConsultaAreaTrabajo"})
public class ConsultaAreaTrabajo extends HttpServlet {
    ...
    protected void cargarTabla(HttpServletRequest request, HttpServletResponse response)
        ...
        List<AreaTrabajo> area = controlador.findAreaTrabajoEntities();
        List<JsonObject> areasJson = new ArrayList<>();

        for (AreaTrabajo areas : area) {
            JsonObject aJson = new JsonObject();
            aJson.addProperty("codigo", areas.getCodigo());
            aJson.addProperty("nombre", areas.getNombre());
