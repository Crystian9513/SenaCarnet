 ...
 * @author Peralta
 */
@WebServlet(name = "ConsultaAdministrador", urlPatterns = {"/ConsultaAdministrador"})
public class ConsultaAdministrador extends HttpServlet {
    ...
    protected void cargarTabla(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Administrador> administradores = controlador.findAdministradorEntities();

        // Crear la respuesta JSON
        String json = new Gson().toJson(administradores);
